...
import com.vas.aos.core.application.pubsub.OrderApprovedPublisher;
...
@Slf4j
@Component
public class KafkaOrderApprovedProducer implements OrderApprovedPublisher {

    @Value("${spring.kafka.topic.new-order-approved}")
    private String newOrderApprovedTopic;
    ...
    @Override
    public void publish(OrderApprovedEventDTO message) {
        ...
        Message<JsonNode> m = MessageBuilder.withPayload(jsonMessage)
                .setHeader(KafkaHeaders.TOPIC, newOrderApprovedTopic)
